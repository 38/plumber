 ...
 * @param first_token The expected first token
 ...
 **/
int pss_comp_block_parse(pss_comp_t* comp, pss_comp_lex_token_t first_token, pss_comp_lex_token_t last_token, pss_comp_block_t* result);
