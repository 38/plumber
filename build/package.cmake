					...
					if(build_${target} STREQUAL "yes")
						...
						if("${TYPE}" STREQUAL "static-library" OR "${TYPE}" STREQUAL "shared-library")
							...
							foreach(test ${unit_tests})
								...
								add_binary_test(${test_name} ${outdir}/${test_name} 30)
							endforeach(test)
						endif("${TYPE}" STREQUAL "static-library" OR "${TYPE}" STREQUAL "shared-library")

						if(NOT "${POST_CONF_SCRIPT}" STREQUAL "")
							include("${SOURCE_PATH}/${POST_CONF_SCRIPT}")
						endif(NOT "${POST_CONF_SCRIPT}" STREQUAL "")
