#message("--------------------------------------------------------")
file(GLOB servlets RELATIVE ${CMAKE_CURRENT_SOURCE_DIR}/${SERVLET_DIR} "${CMAKE_CURRENT_SOURCE_DIR}/${SERVLET_DIR}/*")
foreach(servlet ${servlets})
	if(NOT "${build_${servlet}}" STREQUAL "no")
		if(IS_DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}/${SERVLET_DIR}/${servlet}")
			set(SOURCE_PATH ${CMAKE_CURRENT_SOURCE_DIR}/${SERVLET_DIR}/${servlet})
			set(SOURCE "")
			set(LOCAL_CFLAGS )
			set(LOCAL_LIBS )
			set(LOCAL_INCLUDE )
			set(INSTALL "no")
			include("${CMAKE_CURRENT_SOURCE_DIR}/${SERVLET_DIR}/${servlet}/build.cmake")
			if(NOT "${build_${servlet}}" STREQUAL "no")
				...
				list(APPEND LOCAL_INCLUDE "${CMAKE_CURRENT_SOURCE_DIR}/${SERVLET_DIR}/${servlet}/include")
				...
				if("${INSTALL}" STREQUAL "yes")
					install(TARGETS ${servlet} DESTINATION lib/plumber/servlet)
			...
			compile_protocol_type_files("${servlet}" "${CMAKE_CURRENT_SOURCE_DIR}/${SERVLET_DIR}/${servlet}/protocol")
		endif(IS_DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}/${SERVLET_DIR}/${servlet}")
	endif(NOT "${build_${servlet}}" STREQUAL "no")
endforeach(servlet ${servlets})
